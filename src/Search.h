...
class Search {
    public:     
        ...
        priority_queue<State15, vector<State15>, astarFunct_15> openAstar_15;
        ...
        void print_search_15(State15 init_state, chrono::steady_clock::time_point begin, chrono::steady_clock::time_point end, State15 final_state,float avr);
};